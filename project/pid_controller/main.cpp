...
int main ()
{
  ...
  **/
  double steer_kpi =  0.3;
  double steer_kii = 0.001;
  ...
  **/
  ...
  double throttle_kii = 0.0025;
  double throttle_kdi = 0.01;

  PID pid_steer = PID();
  PID pid_throttle = PID();
  
  pid_steer.Init(steer_kpi, steer_kii, steer_kdi, 1.2, -1.2);
  pid_throttle.Init(throttle_kpi, throttle_kii, throttle_kdi, 1.0, -1.0);
